                ...
                <div className="overflow-y-auto max-h-40 md:max-h-[80vh] md:w-1/4 mr-4">
                    {genres.map((genre) => (
                        <button
                            ...
                            className={`block w-full text-left p-2 rounded ${selectedGenre === genre.id ? 'bg-blue-700 text-white' : 'hover:bg-blue-200'
                                }`}
                        >
                            {genre.name}
                        </button>
                ...
                {!selectedGenre && !loading && (
                    <div className="flex-1">
                        ...
                        <div className="mt-4 flex justify-between">
                            <button
                                className="bg-black hover:bg-grey text-black font-bold py-2 px-4 rounded cursor-pointer"
